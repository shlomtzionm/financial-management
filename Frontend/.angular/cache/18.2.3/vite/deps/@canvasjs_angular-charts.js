      ...
      v = Ra.Chart = function() {
        ...
        t.prototype.renderIndexLabels = function(a) {
          ...
          for (a = 0; a < this._indexLabels.length; a++) {
            ...
            if (null !== t2 && "" !== t2) {
              ...
              } else if ("waterfall" === p || "error" === p && !m.axisSwapped) {
                if (m.dataPoint.x < z3.viewportMinimum || m.dataPoint.x > z3.viewportMaximum || m.bounds.y1 > c.y2 || m.bounds.y2 < c.y1) continue;
        ...
        t.prototype.renderRangeArea = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var g2 = 0; g2 < a.dataSeriesIndexes.length; g2++) {
              ...
              if (0 < p.length) {
                var u = m._colorSet[f % m._colorSet.length], z3 = m.lineColor = m.options.lineColor || u, A2 = z3;
                b.fillStyle = u;
                b.strokeStyle = z3;
                b.lineWidth = m.lineThickness;
                var B = "solid";
                ...
                for (var K = true; f < p.length; f++) if (s = p[f].x.getTime ? p[f].x.getTime() : p[f].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !K))) if (null !== p[f].y && p[f].y.length && "number" === typeof p[f].y[0] && "number" === typeof p[f].y[1]) {
                  ...
                  f < p.length - 1 && (A2 !== (p[f].lineColor || z3) || B !== (p[f].lineDashType || m.lineDashType)) && (d(), A2 = p[f].lineColor || z3, l2[l2.length - 1].newStrokeStyle = A2, b.strokeStyle = A2, b.setLineDash && (p[f].lineDashType ? (B = p[f].lineDashType, l2[l2.length - 1].newLineDashArray = I(B, m.lineThickness), b.setLineDash(l2[l2.length - 1].newLineDashArray)) : (B = m.lineDashType, l2[l2.length - 1].newLineDashArray = J2, b.setLineDash(J2))));
            ...
            for (var g2 = 0; g2 < a.dataSeriesIndexes.length; g2++) {
              ...
              if (0 < m.length) {
                ...
                for (f = false; p < m.length; p++) if (q = m[p].x.getTime ? m[p].x.getTime() : m[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !f))) if (null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" === typeof m[p].y[1]) {
                  ...
                  p < m.length - 1 && (u !== (m[p].lineColor || C) || z3 !== (m[p].lineDashType || k.lineDashType)) && (u = m[p].lineColor || C, w[w.length - 1].newStrokeStyle = u, b.setLineDash && (m[p].lineDashType ? (z3 = m[p].lineDashType, w[w.length - 1].newLineDashArray = I(z3, k.lineThickness)) : (z3 = k.lineDashType, w[w.length - 1].newLineDashArray = A2)));
                  ...
                  f = false;
                } else 0 < p && !f && (k.connectNullData ? b.setLineDash && 0 < w.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType) && (w[w.length - 1].newLineDashArray = B, z3 = k.nullDataLineDashType) : (d(A2, C), w = [], y = [])), f = true;
                d(A2, C);
                aa.drawMarkers(h);
              }
            }
        ...
        t.prototype.renderWaterfall = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
              ...
              if (0 < y.length) for (var u = 5 < q && w.bevelEnabled ? true : false, z3 = false, A2 = null, B = null, n = 0; n < y.length; n++) if (y[n].getTime ? m = y[n].x.getTime() : m = y[n].x, "number" !== typeof y[n].y) {
                if (0 < n && !z3 && w.connectNullData) var G2 = w.options.nullDataLineDashType || !y[n - 1].lineDashType ? w.nullDataLineDashType : y[n - 1].lineDashType;
                z3 = true;
              } else {
                ...
                0 < n && A2 && (!z3 || w.connectNullData) && (z3 && c.setLineDash && c.setLineDash(I(G2, s)), c.beginPath(), c.moveTo(A2, B - v3), c.lineTo(K, L - v3), 0 < s && c.stroke(), r && (b.beginPath(), b.moveTo(A2, B - v3), b.lineTo(K, L - v3), 0 < s && b.stroke()));
                z3 = false;
                A2 = J2;
                B = 0 < y[n].y ? l2 : k;
        ...
        t.prototype.renderPie = function(a) {
          function d() {
            if (k && m) {
              ...
              for (var d2 = 0; d2 < m.length; d2++) {
                ...
                g3.endAngle = g3.startAngle + 2 * Math.PI / z3 * Math.abs(h2.y);
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            a = false;
            for (var A2 = 0; A2 < m.length; A2++) z3 += Math.abs(m[A2].y), !a && "undefined" !== typeof m[A2].indexLabel && null !== m[A2].indexLabel && 0 < m[A2].indexLabel.toString().length && (a = true), !a && "undefined" !== typeof m[A2].label && null !== m[A2].label && 0 < m[A2].label.toString().length && (a = true);
            if (0 !== z3) {
              ...
              var G2 = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Ua(k.innerRadius, B) : 0.7 * B, J2 = Math.min(G2 / B, (B - 1) / B);
